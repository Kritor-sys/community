...
public class RedisTests {
    ...
    public void testSortSet(){
        ...
        System.out.println(redisTemplate.opsForZSet().add(redisKey, "aa", 10));
        System.out.println(redisTemplate.opsForZSet().add(redisKey, "bb", 20));
        System.out.println(redisTemplate.opsForZSet().add(redisKey, "cc", 30));
